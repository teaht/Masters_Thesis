...
pitch_model_RHH <- glm(sub_fl ~ Pitch+
                         ...
                         p_throws, 
                       data = df_right_sub_train, family = binomial)
summary(pitch_model_RHH) # AIC 4641
...
loc_model_RHH <- glm(sub_fl ~ Location+
                       ...
                       p_throws, 
                     data = df_right_sub_train, family = binomial)
summary(loc_model_RHH) # AIC 4497
...
int_model_RHH <- glm(sub_fl ~ Pitch*Location+
                       ...
                       p_throws, 
                     data = df_right_sub_train, family = binomial)
summary(int_model_RHH) # AIC 3459


#--------------------------------------------------------------------------------
# MODEL USED
#--------------------------------------------------------------------------------
summary(int_model_RHH) # AIC 3424
...
# show metrics
round(accuracy, 2)     # 0.80
round(precision, 2)     # 0.84
round(recall, 2)        # 0.83
round(f1_score, 2)      # 0.83
round(specificity, 2)    # 0.77
round(auc(roc_obj), 2)    # 0.89
...
# show metrics
round(accuracy, 2)  # 0.80
round(precision, 2)  # 0.83
round(recall, 2)     # 0.83
round(f1_score, 2)    # 0.83
round(specificity, 2)   # 0.76
round(auc(roc_obj), 2)    # 0.88
...
pitch_model_LHH <- glm(sub_fl ~ Pitch+
                         ...
                         p_throws, 
                       data = df_left_sub_train, family = binomial)
summary(pitch_model_LHH) # AIC 1430
...
loc_model_LHH <- glm(sub_fl ~ Location+
                       ...
                       p_throws, 
                     data = df_left_sub_train, family = binomial)
summary(loc_model_LHH) # AIC 1270
...
# show metrics
round(accuracy, 2)     # 0.91
round(precision, 2)     # 0.93
round(recall, 2)        # 0.82
round(f1_score, 2)      # 0.87
round(specificity, 2)    # 0.96
...
# show metrics
round(accuracy, 2)  # 0.90
round(precision, 2)  # 0.92
round(recall, 2)     # 0.81
round(f1_score, 2)    # 0.86
round(specificity, 2)   # 0.95
