...
summary(base_model_RHH) # AIC 3175
...
pitch_model_RHH <- glm(sub_fl ~ Pitch+
                         ...
                         p_throws, 
                       data = df_right_sub_train, family = binomial)
summary(pitch_model_RHH) # AIC 3310
...
loc_model_RHH <- glm(sub_fl ~ Location+
                       ...
                       p_throws, 
                     data = df_right_sub_train, family = binomial)
summary(loc_model_RHH) # AIC 3171
...
int_model_RHH <- glm(sub_fl ~ Pitch*Location+
                       ...
                       p_throws, 
                     data = df_right_sub_train, family = binomial)
summary(int_model_RHH) # AIC 3135
...
# show metrics
round(accuracy, 2)     # 0.64
round(precision, 2)     # 0.61
round(recall, 2)        # 0.65
round(f1_score, 2)      # 0.63
round(specificity, 2)    # 0.64
round(auc(roc_obj), 2)    # 0.70
...
summary(base_model_LHH) # AIC 1858
...
pitch_model_LHH <- glm(sub_fl ~ Pitch+
                         ...
                         p_throws, 
                       data = df_left_sub_train, family = binomial)
summary(pitch_model_LHH) # AIC 1979
...
loc_model_LHH <- glm(sub_fl ~ Location+
                       ...
                       p_throws, 
                     data = df_left_sub_train, family = binomial)
summary(loc_model_LHH) # AIC 1854
...
int_model_LHH <- glm(sub_fl ~ Pitch*Location+
                       ...
                       p_throws, 
                     data = df_left_sub_train, family = binomial)
summary(int_model_LHH) # AIC 1865
...
round(precision, 2)     # 0.65
round(recall, 2)        # 0.63
round(f1_score, 2)      # 0.64
round(specificity, 2)    # 0.61
