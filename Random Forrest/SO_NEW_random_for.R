...
# OOB estimate of  error rate: 17.54% (lower the better)
# Variable importance
...
# show metrics
round(accuracy, 2)     # 59
round(precision, 2)    # 37
round(recall, 2)       # 64
round(f1_score, 2)      # 47
round(specificity, 2)   # 57
round(auc(roc_obj), 2)    # 100
...
print(rf_model)# better at predicting SOs, not non-SOs
# OOB estimate of  error rate: 10.81% (lower the better)
# Variable importance
varImp <- importance(rf_model)
print(varImp[order(varImp[, "MeanDecreaseAccuracy"], decreasing = TRUE), ])
# MeanDecreaseAccuracy: Drop in model accuracy when 
...
# show metrics
round(accuracy, 2)     #0.93
round(precision, 2)    # 0.99
round(recall, 2)       # 0.88
round(f1_score, 2)      # 0.93
round(specificity, 2)   # 0.99
...
# show metrics
round(accuracy, 2)     #0.55
round(precision, 2)    # 0.15
round(recall, 2)       # 0.62
round(f1_score, 2)      # 0.24
round(specificity, 2)   # 0.54
