...
#--------------------------------------------------------------------
table(df2$sub_fl) # FALSE=3659, TRUE=380
...
# OOB estimate of  error rate: 12.44% (lower the better)
# Variable importance
...
# show metrics
round(accuracy, 2)     #0.87
round(precision, 2)    # 0.92
round(recall, 2)       # 0.83
round(f1_score, 2)      # 0.87
round(specificity, 2)   # 0.92
...
# show metrics
round(accuracy, 2)     #0.89
round(precision, 2)    # 0.96
round(recall, 2)       # 0.85
round(f1_score, 2)      # 0.9
round(specificity, 2)   # 0.94
round(auc(roc_obj), 2)    # 0.96




#--------------------------------------
# LHH Reduced Model - Pitch
#--------------------------------------
# clean data for model 
...
print(rf_model)# better at predicting SOs, not non-SOs
# OOB estimate of  error rate: 13.04% (lower the better)
# Variable importance
varImp <- importance(rf_model)
print(varImp[order(varImp[, "MeanDecreaseAccuracy"], decreasing = TRUE), ])
# MeanDecreaseAccuracy: Drop in model accuracy when 
...
# show metrics
round(accuracy, 2)     #0.86
round(precision, 2)    # 0.94
round(recall, 2)       # 0.83
round(f1_score, 2)      # 0.88
round(specificity, 2)   # 0.92
round(auc(roc_obj), 2)    # 1
...
# show metrics
round(accuracy, 2)     #0.86
round(precision, 2)    # 0.95
round(recall, 2)       # 0.81
round(f1_score, 2)      # 0.88
round(specificity, 2)   # 0.93
round(auc(roc_obj), 2)    # 0.95
