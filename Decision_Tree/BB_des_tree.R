...
#--------------------------------------------------------------------
# Question 1: Walk vs what pitch count and location?
#--------------------------------------------------------------------
# Prepare Data
...
# fit general decision tree 
# assumptions are good based on regression 
...
nrow(df_left_sub_test)

#-----------------------------------------------------------------
# RHH Reduced Model - Pitch and Location
#-----------------------------------------------------------------
...
reduced_model <- rpart(sub_fl ~ Pitch+Location+
                         line_up_pos+
                         LBSU_score+
                         OPP_score+
                         num_outs+
...
title("Reduced Tree: 76% Accuracy") 
...
# show metrics
round(accuracy, 2)     #0.78
round(precision, 2)    # 0.71
round(recall, 2)       # 0.85
round(f1_score, 2)      # 0.77
round(specificity, 2)   # 0.73
round(auc(roc_obj), 2)    # 0.81
...
round(precision, 2)    # 0.63
round(recall, 2)       # 0.52
round(f1_score, 2)      # 0.57
round(specificity, 2)   # 0.74
...
round(precision, 2)    # 0.91
round(recall, 2)       # 0.71
round(f1_score, 2)      # 0.80
round(specificity, 2)   # 0.83
round(auc(roc_obj), 2)    # 0.74
...
# show metrics
round(accuracy, 2)     #0.62
round(precision, 2)    # 0.46
round(recall, 2)       # 0.60
round(f1_score, 2)      # 0.52
round(specificity, 2)   # 0.63
round(auc(roc_obj), 2)    # 0.41
