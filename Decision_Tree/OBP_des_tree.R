...
#--------------------------------------------------------------------
# Question 1: OBP vs what pitch count and location?
#--------------------------------------------------------------------
# Prepare Data
...
round(precision, 2)    # 0.49
round(recall, 2)       # 0.66
round(f1_score, 2)      # 0.56
round(specificity, 2)   # 0.56
round(auc(roc_obj), 2)    # 0.61
...
round(specificity, 2)   # 0.57*
round(auc(roc_obj), 2)    # 0.65 
