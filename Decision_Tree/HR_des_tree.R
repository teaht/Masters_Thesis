...
title("Reduced Tree: 83% Accuracy") 
...
round(precision, 2)    # 1
round(recall, 2)       # 0.70
round(f1_score, 2)      # 0.82
round(specificity, 2)   # 0.91
round(auc(roc_obj), 2)    # 0.83
...
# show metrics
round(accuracy, 2)     #0.92
round(precision, 2)    # 1
round(recall, 2)       # 0.81
round(f1_score, 2)      # 0.90
round(specificity, 2)   # 0.1
...
round(precision, 3)    # 1 
round(recall, 2)       # 0.80
round(f1_score, 2)      # 0.89
round(specificity, 3)   # 1 
round(auc(roc_obj), 2)    # 0.94
